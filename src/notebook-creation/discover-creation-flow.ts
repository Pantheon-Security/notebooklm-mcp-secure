...
// `node dist/notebook-creation/discover-creation-flow.js`), never on import.
// This keeps the 60s keep-open and the authenticated browser session from
// firing when the package imports this module.
const isDirectRun = (() => {
